...
public class RateCalculator {
	...
	public void CostComparsion(double miles, double year, double hwyPercentage) {
		...
		// calculate the max saving and city compare driving EV and ICE.
		...
		/**
		 * Use national average data to compare tesla,mercedes and lexus cost for 15,000
		 * miles/
		 */
		...
		/**
		 * Answer some questions and output answers in one txt file.
		 */
		...
		answers.add("If you live in Charlotte, Mercede will cost you $" + df2.format(CharlotteOneYearMercedes)
		...
		answers.add("If you live in New York, Mercede will cost you $" + df2.format(NewYorkOneYearMercedes)
		...
		answers.add("If you live in Miami, Mercede will cost you $" + df2.format(MiamiOneYearMercedes) + " in 1 year; $"
	...
	/**
	 * getter methods for all EV rate in 3 different cities.
	 * @return
	 */
	...
	/**
	 * This method will take user's input of month, and return 2 arraylists which contain all daily cost of that particular month before and after EV charge.
