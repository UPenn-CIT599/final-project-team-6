...
public class ICEUsageReader {
	...
	public ICEUsageReader(String filename) {
		...
		try {
			Scanner scanner = new Scanner(file); // creates scanner object
			scanner.nextLine(); // reads and discards the first line (header of csv)
			while (scanner.hasNextLine()) { // while there is a next line
				String ICERow = scanner.nextLine(); // stores the current line in a String
				String[] columnData = ICERow.split(","); // parses by the comma
