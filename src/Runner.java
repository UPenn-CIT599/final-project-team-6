...
public class Runner {
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(() -> {
			...
			for (int i = 0; i < factor.EVPlot.size(); i++) {
				System.out.println("WithEV" + factor.EVPlot.get(i));
				
				EwithEV.put(i, factor.EVPlot.get(i));
			}

			for (int i = 0; i < factor.nonEVPlot.size(); i++) {
				System.out.println("WithoutEV" + factor.nonEVPlot.get(i));
				EwithoutEV.put(i, factor.nonEVPlot.get(i));
			}
