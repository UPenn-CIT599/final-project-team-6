...
public class Runner {
	...
	public static void main(String[] args) {
		/**
		 * Inputs file names and creates new object.
		 */
		...
		/**
		 * Asks user for input the three parameters: miles, number of years desired in vehicle and % of highway miles to check whether or not
		...
		// Prompts user to enter the month for electricity usage data to plot
		...
		/**
		 * Plots two curves in one graph per user's input.
		 */
