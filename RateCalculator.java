...
/**
 * This class contains a set of basic math functions for obtaining the electricity and gasoline-related values called in select formula.
 *
 */
public class RateCalculator {

	/**
	 * Sets the output to print 2 digits only.
	 */
	...
	/**
	 * This method will take two arraylists (before EV bill and after EV bill) to find
	 * how much electricity will be consumed in 6 months. Then calculate total driving
	 ...
	 * how much electricity will be consumed in 6 months, and the associated cost.
	...
	/**
	 * Returns the average electricity cost for 3 years in New York, NY.
	 */
	public double NewYorkElectricityRate() {
	...
	/**
	 * Returns the average electricity cost for 3 years in Miami, FL.
	 */
	public double MiamiElectricityRate() {
	...
	/**
	 * This method retrieves input from a user and returns the data to compare
	 * the Tesla, Mercedes,and Lexus vehicles in Charlotte, New York, and Miami.
	 * @param miles
	 * @param year
	 * @param hwyPercentage
	 */
	...
	public void CostComparsion(double miles, double year, double hwyPercentage) {
		...
		/*
		 * Calculates the max saving and city comparisons for driving the Tesla and ICE vehicles.
		 */
		...
		/*
		 * Uses national average data to compare the Tesla, and both the Mercedes GLC and Lexus LX
		 * cost for 15,000 miles driven annually.
		 */
		...
		/*
		 * Answers select questions and outputs answers in .txt file.
		 */
