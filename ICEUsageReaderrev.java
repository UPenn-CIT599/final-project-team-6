...
public class ICEUsageReaderrev {
	/*
	...
	/*
	 * creates one HashMap to store data through csv files, and convert data to int or double.
	 */
	private HashMap<Integer, ICEUsage> gasMap;
	
	/*
	 * Constructor
	 * Reads in the given file, parses the data and populates the ICEUsage class with the data.
	 * @param file2
	 */
	public ICEUsageReaderrev(String file2) {
		...
		try {
			...
			while (scanner.hasNextLine()) { //while there is a next line
				...
				/*
				 * Creates an ICEUsage object and initializes the values
				 */
				
				ICEUsage ice = new ICEUsage(model, city, regularGas, premiumGas, cityMPG, hwyMPG);
				gasMap.put(Integer.parseInt(columnData[0]), ice); //populate the gasMap hashmap
			}
	 ...
	 * 1. assign city and highway MPG to both Lexus LX and Mercedes GLC ICE vehicles
