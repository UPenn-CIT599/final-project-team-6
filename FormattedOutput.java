...
/**
 * This class collects the answers for each prompt in the RateCalculator class and compiles it into a text file.
 * The name of the text file is "Team6Q&A.txt" 
 */
public class FormattedOutput {

	/**
	 * Creates an arraylist for storing the answers to each prompt.
	 */
