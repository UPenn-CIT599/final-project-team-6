...
class JunitTest {
	...
	void TestEachMonthlyCost() {
		ElectricUsageReader TeslaUsage = new ElectricUsageReader("09-2019--03-2020.csv");
		double[] monthofFebdouble = {0.46, 0.92, 2.03, 2.03, 2.31, 1.38, 2.58, 2.58, 4.24, 2.21, 1.38, 1.75, 1.75, 3.6, 3.96, 3.87, 1.29, 1.84, 3.04, 2.31, 2.21, 3.13, 2.4, 2.4, 1.94, 1.94, 4.89, 3.23};
	...
	void TestmonthofPlot() {
		...
		double[] NmonthofOct = {2.42, 2.7, 0.56, 0.47, 0.47, 0.37, 0.47, 0.93, 3.16, 0.37, 0.56, 0.56, 1.02, 0.93, 3.35, 1.86, 0.56, 1.58, 1.12, 0.56, 0.56, 2.05, 1.21, 0.56, 1.3, 0.37, 0.84, 0.74, 0.74, 0.28, 0.28};
		ArrayList<Double> NMO = new ArrayList<Double>();
		for(int i = 0; i< NmonthofOct.length; i++) {
			NMO.add(NmonthofOct[i]);
		}
		double[] EmonthofOct = {0.46, 0.74, 0.83, 0.92, 2.67, 2.58, 3.96, 3.22, 1.47, 1.47, 2.67, 4.33, 4.33, 0.37, 1.11, 1.29, 1.38, 3.41, 3.22, 0.92, 1.93, 2.86, 3.68, 2.12, 2.12, 0.83, 0.83, 0.83, 1.57, 2.12, 3.68};
